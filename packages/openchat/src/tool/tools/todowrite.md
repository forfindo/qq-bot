Create and maintain a structured task list for the current coding session. Tracks progress, organizes multistep work, and surfaces status to the user.
...
Use it:
- "Add a dark mode toggle and run the tests" -> multistep feature + explicit verification
