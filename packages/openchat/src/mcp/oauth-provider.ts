...
import type { Interface } from '@/mcp/auth';
...
export class McpOAuthProvider implements OAuthClientProvider {
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      ...
      client_name: 'OpenChat',
      client_uri: 'https://github.com/forfindo/qq-bot',
    ...
    await Effect.runPromise(
      this.auth.updateTokens(
        this.mcpName,
        {
          ...
          expiresAt: tokens.expires_in ? Date.now() / 1000 + tokens.expires_in : void 0,
          scope: tokens.scope
        },
        this.serverUrl
      )
