...
export abstract class NamedError extends Error {
  ...
  static create<Name extends string, Fields extends Schema.Struct.Fields>(name: Name, fields: Fields): ReturnType<typeof NamedError.createSchemaClass<Name, Schema.Struct<Fields>>>;
  static create<Name extends string, DataSchema extends Schema.Top>(name: Name, data: DataSchema): ReturnType<typeof NamedError.createSchemaClass<Name, DataSchema>>;
